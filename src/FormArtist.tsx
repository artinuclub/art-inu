...
const FormArtist: React.FC<Props> = ({
  balanceOf,
  account,
}) => {
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold">You're an NFT artist and want to earn money?</h2>
        <p className="text-gray-500 mb-8">Submit your profile and start earning rewards</p>
    <div>
      <p>You have <span className="text-artinuMain font-semibold">{balanceArtinuFinal} ARTINU</span>  in your wallet</p>
    </div>
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Input 
       type="Name"
       placeholder="Link to NFT profile"
      />
